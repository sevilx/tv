#!MANAGED-CONFIG https://cwv587.com/link/rW3QhJFrvsWJc3OF?clash=1

#---------------------------------------------------#
## 上次更新于：2022-01-16 10:09:52
#---------------------------------------------------#
...
proxies:
  -
    name: '🇭🇰  香港 ➤ 高速 ➤ x1'
    type: vmess
    server: hkgs.v2yun.vip
    port: 80
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
    alterId: 0
    cipher: auto
    udp: true
    network: ws
    ws-opts:
      path: /
      headers: { Host: hkgs.v2yun.vip }
  -
    name: '🇭🇰  香港03 ➤ 高速Tcp线路（超低延迟） ➤ x1'
    type: vmess
    server: hk03gs.v2yun.vip
    port: 80
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
    alterId: 0
    cipher: auto
  ...
  -
    ...
    ws-opts:
      path: /
      headers: { Host: hkfree.v2yun.vip }
  -
    name: '中转80口 ➤ 负载均衡 ➤ x1'
    type: vmess
    server: 115.227.8.199
    port: 80
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
    alterId: 0
    cipher: auto
  ...
  -
    ...
    ws-opts:
      path: /
      headers: { Host: 2.v2yun.vip }
  -
    name: '🇷🇺 俄罗斯 ➤ 公益免费 ➤ x0'
    type: vmess
    server: rufree.v2yun.vip
    port: 80
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
    alterId: 0
    cipher: auto
  ...
  -
    ...
    ws-opts:
      ...
      headers: { Host: 2.v2yun.vip }
  -
    name: '🇹🇼 台湾 ➤ 原生ip解锁Netflix 动漫等流媒体 ➤ x1'
    type: vmess
    server: 1.v2yun.vip
    port: 22978
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
  ...
  -
    ...
    ws-opts:
      path: /
      headers: { Host: usgia.v2yun.vip }
  -
    name: '🇺🇲 洛杉矶 ➤ 原生ip解锁disney neftlix等流媒体 ➤ x1'
    type: vmess
    server: 2.v2yun.vip
    port: 29934
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
  ...
  -
    ...
    ws-opts:
      path: /
      headers: { Host: krgs.v2yun.vip }
  -
    name: '🇰🇷 韩国 ➤CN2+超低延迟游戏线路 ➤x10'
    type: vmess
    server: krcn2.v2yun.vip
    port: 80
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
    alterId: 0
    cipher: auto
    ...
    ws-opts:
      path: /
      headers: { Host: krcn2.v2yun.vip }
  -
    name: '🇭🇰 香港 ➤ 5GB带宽优质线路 ➤ x1'
    type: vmess
    server: hk5gb.v2yun.vip
    port: 80
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
    alterId: 0
    cipher: auto
    ...
    ws-opts:
      path: /
      headers: { Host: hk5gb.v2yun.vip }
  -
    name: '🇭🇰 香港 ➤ 三网优化专线 ➤ x1'
    type: vmess
    server: hk3wyhzx.v2yun.vip
    port: 80
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
    alterId: 0
    cipher: auto
    ...
    ws-opts:
      path: /
      headers: { Host: hk3wyhzx.v2yun.vip }
  -
    name: '🇭🇰 香港 ➤ 独享 ➤ x1'
    type: vmess
    server: hkdx.v2yun.vip
    port: 80
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
    alterId: 0
    cipher: auto
  ...
  -
    ...
    ws-opts:
      ...
      headers: { Host: gd.189.cn }
  -
    name: '🇭🇰 香港5 ➤ 独享tcp线路（超低延迟） ➤ x1'
    type: vmess
    server: hk5dx.v2yun.vip
    port: 80
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
    alterId: 0
    cipher: auto
    udp: true
  -
    name: '🇭🇰 香港CMI线路 ➤解锁香港解鎖Netflix TVB HKTV ViuTV等流媒体➤x1'
    type: vmess
    server: 1.v2yun.vip
    port: 12365
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
    ...
    ws-opts:
      ...
      headers: { Host: 1.v2yun.vip }
  -
    name: '🇭🇰 香港HGC线路 ➤解锁香港解鎖Netflix TVB HKTV ViuTV等流媒体➤x1'
    type: vmess
    server: 1.v2yun.vip
    port: 10031
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
    ...
    ws-opts:
      ...
      headers: { Host: 1.v2yun.vip }
  -
    name: '🇭🇰 香港WTT线路 ➤解锁香港解鎖Netflix TVB HKTV ViuTV等流媒体➤x1'
    type: vmess
    server: 1.v2yun.vip
    port: 10025
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
    ...
    ws-opts:
      ...
      headers: { Host: 1.v2yun.vip }
  -
    name: '🇭🇰 香港负载均衡 ➤Tcp线路（超低延迟） ➤x1'
    type: vmess
    server: hkfzjh.v2yun.vip
    port: 80
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
    alterId: 0
    cipher: auto
    udp: true
  -
    name: '🇲🇾 马来西亚 ➤ 解锁超多流媒体NF spofity kkbox steam 等等 ➤ x1'
    type: vmess
    server: 1.v2yun.vip
    port: 10649
    uuid: a386ff56-613a-3290-bcec-29fd1960f43a
...
proxy-groups:
  -
    ...
    proxies:
      ...
      - '🇩🇪 德国 ➤ 高速 ➤ x1'
      - '🇯🇵 日本 ➤ 原生ip解锁Netflix等流媒体 ➤ x1'
      - '🇯🇵 日本 ➤ 高速 ➤ x1'
      - '🇫🇷 法国 ➤ 巴黎高速 ➤ x1'
      - '🇺🇲 洛杉矶 ➤ gia线路 ➤ x1'
      - '🇺🇲 洛杉矶 ➤ 原生ip解锁disney neftlix等流媒体 ➤ x1'
      - '🇺🇲 洛杉矶 ➤ 高速➤x1'
      - '🇳🇱 荷兰 ➤ 高速 ➤ x1'
      - '🇰🇷 韩国 ➤ 高速 ➤ x1'
      - '🇰🇷 韩国 ➤CN2+超低延迟游戏线路 ➤x10'
      ...
      - '🇭🇰 香港1 ➤ 独享 ➤ x1'
      - '🇭🇰 香港5 ➤ 独享tcp线路（超低延迟） ➤ x1'
      - '🇭🇰 香港CMI线路 ➤解锁香港解鎖Netflix TVB HKTV ViuTV等流媒体➤x1'
      - '🇭🇰 香港HGC线路 ➤解锁香港解鎖Netflix TVB HKTV ViuTV等流媒体➤x1'
      - '🇭🇰 香港WTT线路 ➤解锁香港解鎖Netflix TVB HKTV ViuTV等流媒体➤x1'
      - '🇭🇰 香港负载均衡 ➤Tcp线路（超低延迟） ➤x1'
      - '🇲🇾 马来西亚 ➤ 解锁超多流媒体NF spofity kkbox steam 等等 ➤ x1'
